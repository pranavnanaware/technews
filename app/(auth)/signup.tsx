...
export default function SignUpScreen() {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      // Implement Supabase signup with magic link
      const { data, error } = await supabase.auth.signInWithOtp({
        email: email.trim().toLowerCase(),
        options: {
          // You can customize the magic link here
          emailRedirectTo: 'yourapp://login', // Configure this based on your app's deep linking setup
        },
      });
